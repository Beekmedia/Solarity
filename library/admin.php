...
function solarity_rss_dashboard_widget() {
	...
	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date( __( 'j F Y @ g:i a', 'solarity' ), $item->get_date( 'Y-m-d H:i:s' ) ); ?>" target="_blank">
...
function solarity_custom_dashboard_widgets() {
	wp_add_dashboard_widget( 'solarity_rss_dashboard_widget', __( 'Recently on Themble (Customize on admin.php)', 'solarity' ), 'solarity_rss_dashboard_widget' );
	/*
...
add_action( 'wp_dashboard_setup', 'solarity_custom_dashboard_widgets' );
